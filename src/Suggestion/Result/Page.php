 ...
 * @subpackage Elasticsearch
 */
class PapayaModuleElasticsearchSuggestionResultPage extends PapayaObjectInteractive
    implements
  ...
  /**
   * @var PapayaModuleElasticsearchSuggestionResultPageContent
   */
  ...
  public function cacheable(PapayaCacheIdentifierDefinition $definition = NULL) {
    if (isset($definition)) {
      ...
      $this->_cacheDefinition = new PapayaCacheIdentifierDefinitionGroup(
          ...
          new PapayaCacheIdentifierDefinitionParameters(['term'])
      );
    }
  ...
  /**
   *
   * @param PapayaModuleElasticsearchSuggestionResultPageContent $pageContent
   * @return PapayaModuleElasticsearchSuggestionResultPageContent
   */
  public function pageContent(PapayaModuleElasticsearchSuggestionResultPageContent $pageContent = NULL) {
    if (isset($pageContent)) {
      $this->_pageContent = $pageContent;
    } elseif (is_null($this->_pageContent)) {
      $this->_pageContent = new PapayaModuleElasticsearchSuggestionResultPageContent($this);
    }
  ...
  public function createEditor($callbackContext, PapayaPluginEditableContent $content = NULL) {
    $editor = new PapayaModuleElasticsearchSuggestionResultPageEditor($content);
